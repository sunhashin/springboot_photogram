...
<div class="subscribe__item" id="subscribeModalItem-${u.id}">
	...
	if (! u.equalUserState) {  // 동일 유저가 아닐 때 버튼이 만들어 저야 함
...
function profileImageUpload(pageUserId, principalId) {
	...
	$("#userProfileImageInput").on("change", (e) => {
		...
		$.ajax({
			...
			data: formData,
			contentType: false,  //필수 : x-www-form-urlencode로 파싱되는 것을 방지
			processData: false,  // 필수 : contentType 을 false 로  주면 보내는 데이터의 타입이 QueryString 으로 자동 설정됨, 해제해야함
